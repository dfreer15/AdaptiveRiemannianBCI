...
import numpy as np 
from numpy import *
from LSLscripts.testConnect import connect_to_stream
import threading
...
class MyService(rpyc.Service):
    def exposed_trigger_event(self, code, desc):
        return main.save_event(code, desc)

if __name__ == '__main__':
    # start the rpyc server
    server = ThreadedServer(MyService, port = 12348)
